...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:GenerarReciboV2Controller"] = append(beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:GenerarReciboV2Controller"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
    ...
    beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:LegalizacionController"] = append(beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:LegalizacionController"],
        beego.ControllerComments{
            Method: "PutInfoLegalizacionMatricula",
            Router: "/actualizar-info-legalizacion",
            AllowHTTPMethods: []string{"put"},
            MethodParams: param.Make(),
            Filters: nil,
            Params: nil})
    ...
    beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:LegalizacionController"] = append(beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:LegalizacionController"],
        beego.ControllerComments{
            Method: "PutInfoSoportesLegalizacionMatricula",
            Router: "/actualizar-info-soportes-legalizacion",
            AllowHTTPMethods: []string{"put"},
            MethodParams: param.Make(),
            Filters: nil,
            Params: nil})
    ...
    beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:Time_bogController"] = append(beego.GlobalControllerRouter["github.com/udistrital/sga_inscripcion_mid/controllers:Time_bogController"],
        beego.ControllerComments{
            Method: "GetTimeBog",
            Router: "/",
            AllowHTTPMethods: []string{"get"},
